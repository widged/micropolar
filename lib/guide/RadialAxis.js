define(['d3', 'accessmaker'], function(d3, AccessMaker) {
    ...
    var Class = function RadialGuide() {
        ...
        instance.mountIn = function(rootNode) {
            ...
            if(state.showCircle) {
                renderMarks(axisNode, axisCoord);
                renderLabels(axisNode, axisCoord, state.axisTheta, state.ticksSuffix);
            }

            return instance;
        };

        function renderMarks(axisNode, axisCoord) {
        ...
        function renderLabels(axisNode, axisCoord, axisTheta, ticksSuffix) {
