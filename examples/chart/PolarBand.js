define(['d3', 'accessmaker', 'polarplot', 'radialscale', 'angularscale', 'radialaxis', 'angularaxis', 'polarhover', 'polarband'], function(d3, AccessMaker, PolarPlot, RadialScale, AngularScale, RadialAxis, AngularAxis, PolarHover, BandGeom) {
    ...
    var Class = function PolarLine() {
        ...
        function render() {
            ...
            var geomFn = BandGeom.geom(scaleA, scaleR, { originTheta: originTheta});
