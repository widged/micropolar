define(['d3', 'accessmaker', 'polarplot', 'radialscale', 'angularscale', 'radialaxis', 'angularaxis', 'polarhover', 'polarflower'], function(d3, AccessMaker, PolarPlot, RadialScale, AngularScale, RadialAxis, AngularAxis, PolarHover, FlowerGeom) {
    ...
    var Class = function PolarFlower() {
        ...
        function render() {
            ...
            var majorSuffix = state.angularMajorSuffix;
            var majorStep   = state.angularMajorStep || 30;
            var axisTheta   = state.axisTheta || 0;
            ...
            var axisA = (new AngularAxis())
                ...
                .ticks({
                    data: AngularAxis.ticks({perimeter: domainA[1], majorStep: majorStep })
                });
            ...
            var geomFn = FlowerGeom.geom(scaleA, scaleR, { originTheta: originTheta});
